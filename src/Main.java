...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("""
                ...
                'exit' - exit
                'replay' - replay
                'castling0' or 'castling7' - castling
                'move 1 1 2 3' - for move from position 1 1 to 2 3(the field its two-dimensional array from 0 to 7)
                """);
        System.out.println();
        board.printBoard();
        while (true) {
            ...
            if (s.equals("exit")) break;
                ...
                if (s.equals("castling0")) {
                    ...
                    try {
                        ...
                        if (board.moveToPosition(board, line, column, toLine, toColumn)) {
